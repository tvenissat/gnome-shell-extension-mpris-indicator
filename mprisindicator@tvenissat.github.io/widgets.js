...
var MprisIndicatorButton = GObject.registerClass({
    ...
    _init() {
        ...
        let playerIcon = new St.Icon({
            style_class: 'system-status-icon'
        });

        playerIcon.add_effect(new Clutter.DesaturateEffect());
        ...
        indicator.add(artistTitleLabel);
        ...
        let updateIndicator = () => {
            ...
            indicator.first_child.gicon = activePlayer ? activePlayer.gicon : null;
            let visible = indicator.first_child.gicon ? true : false;
